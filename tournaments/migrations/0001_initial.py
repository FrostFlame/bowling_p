    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('game', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='game_players', to='tournaments.Game')),
                ('player', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='player_games', to='accounts.PlayerInfo')),
            ],
        ),
        migrations.CreateModel(
            name='TeamType',
